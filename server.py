...
class Handler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if p=='/api/health': return self.send_json({'ok':True,'version':'V17.4','database':'PostgreSQL' if USE_POSTGRES else 'SQLite','whatsapp':'direct-link-mode','renewals':'receipt-review'})
